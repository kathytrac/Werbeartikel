...
class Captcha {
    ...
    public function __construct( $session, $locale, $assetsPath = null, $defaultImages = null, $defaultAudios = null ) {
        ...
        if ( ! $defaultImages || count( $defaultImages ) == 0 ) {
            if(file_exists($this->assetsPath . "/images_$locale.json")){
                $defaultImages = $this->utilReadJSON( $this->assetsPath . "/images_$locale.json" );
            }else{
