...
class Writer implements WriterInterface
{
     ...
     */
    public function init($filePath, $fileDir, $fileName, $tempFilePath, $storeBaseUrl = false)
    {
     ...
     * @param $changefreq
     * @param $priority
     * @param bool $imageUrls
     * @param bool $alternateUrls
     * @throws LocalizedException
     */
    ...
    protected function openPathAndFileExist()
    {
        ...
        $this->stream = $this->directory->openFile($filePath . $fileName, 'a+');
    }
